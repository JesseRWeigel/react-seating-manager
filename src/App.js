...
//Declaring variables total and occupied to keep a track of the number of seats occupied among the total number of seats
let total = 0
let occupied = 0
...
class App extends Component {
    ...
    makeSeatingChart = (rows, seatsPerRow) => {
        total = rows * seatsPerRow; //Counting total number of seats
        console.log(total)
    ...
    render() {
            ...
            return ( <
                ...
                color = "secondary"
                onClick = {
                    () => this.handleClick(rows, seatsPerRow)
                } >
                ...
                Grid item xs = { 12 } > {
                    ...
                    seatingChart.length > 0 && ( <
                        ...
                        seatNotAvailable && ( <
                            ...
                            gutterBottom >
                            Sorry, that seat is not available.Please select another. <
                            /Typography>
                        )
                    } <
                    TextField id = "row"
    ...
    Grid item xs = { 12 } >
        ...
        Typography variant = "display1"
    gutterBottom >
        Remaining Seats: { total - occupied } <
        /Typography> < /
    Grid > <
        /Grid> < /
    div >
